        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <dl class="row">
                    ...
                    <dd class="col-sm-8"><?= isset($check_in_time) ? date("h:i A", strtotime($check_in_time)) : 'N/A' ?></dd>
                </dl>
            </div>
            <div class="col-md-6">
                <dl class="row">
                    <dt class="col-sm-4">Check-out Time</dt>
                    <dd class="col-sm-8"><?= isset($check_out_time) ? date("h:i A", strtotime($check_out_time)) : 'N/A' ?></dd>
                </dl>
            </div>
        </div>
